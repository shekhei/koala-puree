...
function genModel(file, base, remove, bookshelf, context) {
		...
		setup: function *setupModel(next) {
			...
			yield new Promise(function(resolve, reject){
				...
				glob(_config.base+"*.js", function (er, files) {
					...
					app.models = {};
					for ( var f of files ) {
						let name = genModel(f, _config.base, app._app.env !== "production", app._orm, context);
